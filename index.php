    ...
    <div data-bs-offset="0" tabindex="0">
        ...
        <div class="vertical-center">
          ...
          <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
            <div class="flex-grow-1">
              ...
              <p>3.5 GPA and have completed multiple web development projects for front end. I'm also currently creating and full stack website with a database.</p>
            </div>
      ...
      <div id="skills" class="content-item">
        <div class="vertical-center">
          ...
          <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
            <ul>
              <li>Programming languages: C++, php, JavaScipts, HTML, CSS</li>
              <li>Web design</li>
      ...
      <div id="interests" class="content-item">
        <div class="vertical-center">
          ...
          <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
            <p>Love coding, martial arts, flips and volleyball.</p>
          </div>
